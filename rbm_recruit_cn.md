...
<div class="container">
  ...
  <div class="content">
    <div>
      <p>
        迩来仆专攻<u><strong>红鸟项目</strong></u>之构划。
        <br><br><strong>🚁 其题曰：</strong>
        <br>构建城厢无人机物流之数字孪生体⛈️——破解极端天气对末端物流经济与运营之困局
        <br><br><strong>🔭 项目愿景：从“可行与否”至“智能全气象运营”之飞跃</strong>
        <br>当此<strong>低空经济</strong>方兴未艾之际，无人机物流犹困于天时之桎梏。本项目破局之法，非止于“行止”之判，意在铸就智能多层数字孪生系统，使无人机于重楼叠宇间得展百变翔舞之策。
        <br>此非止工巧之技，实乃<strong>数字孪生政策实验室</strong>之创举。融高精度大气科学、稳健飞行模拟与精深城厢分析于一炉，化天地玄机为经世良策。吾辈所构，非仅避险之器，乃开 resilence 之枢，延运营之窗，拓末端物流新境，终使无人机递送成风雨无阻之良驿。
      </p>
      <hr>
      <p>
        <strong><span style="color: red">📈 项目更新（最后更新于乙巳(2025)年十一月三十日）：</span></strong>
        <br>惜乎前议项目因人员未备而中辍，仆今已加入<a href="https://scholar.google.com/citations?user=JSpKN3sAAAAJ&hl=en">季一丁博士</a>所领之新红鸟项目。旦夕间当以此处主页布告新项详要。
      </p>
      <hr>
      <p>
        <strong>流程纲目：首尾相衔之验证体系</strong>
        <br><br>本项目立基于技术可行之精心规划，使跨学科模块如环无端。自原始地理气象数据，终成高拟真交互数字孪生，堪为决策之明镜。
        <br><img src="/assets/images/workflow_latitudinal.svg" alt="workflow" style="max-width:1400px; height:auto;">
        <br><i>（以下皆西番英吉利文字）</i>A detailed technical breakdown of this workflow can be found in our <u>Feasibility & Toolchain Analysis report</u> (<a href="/assets/documents/Feasibility & Toolchain Analysis report (CN).pdf">中文</a>).
      </p>
      <hr>
      <p>
        <i>（以下皆为西番英吉利文字）</i><br>
